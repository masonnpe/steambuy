...
public class SearchService {
    ...
    public Item buildItem(Spu spu) throws IOException {
        Item Item = new Item();

        //1.查询商品分类名称
        List<String> names = this.itemFeignClient.queryNameByIds(Arrays.asList(spu.getCid1(),spu.getCid2(),spu.getCid3())).getBody();
        //2.查询sku
        ...
        Item.setAll(spu.getTitle() + " " + StringUtils.join(names, " "));
        Item.setPrice(prices);
        Item.setSkus(mapper.writeValueAsString(skuLists));
     ...
     * @return
     */
    public SearchResult<Item> search(SearchRequest searchRequest) {
        ...
        //2.查询、获取结果
        AggregatedPage<Item> pageInfo = (AggregatedPage<Item>) this.itemRepository.search(queryBuilder.build());
        //3.解析查询结果
        //3.1 分页信息
    ...
    public void createIndex(Long id) throws IOException {
        SpuBo spuBo = this.itemFeignClient.queryGoodsById(id);
        //构建商品
    ...
    private List<Map<String, Object>> getSpec(Long id, QueryBuilder basicQuery) {
        ...
        String specsJSONStr = this.itemFeignClient.querySpecificationByCategoryId(id).getBody();
        //1.将规格反序列化为集合
        List<Map<String,Object>> specs = null;
    ...
    private List<Brand> getBrandAggResult(Aggregation aggregation) {
        ...
        //根据品牌id查询品牌
        return this.itemFeignClient.queryBrandByIds(bids);
    }
    ...
    private List<Category> getCategoryAggResult(Aggregation aggregation) {
        ...
        //根据id查询分类名称
        return this.itemFeignClient.queryCategoryByIds(cids).getBody();
    }
